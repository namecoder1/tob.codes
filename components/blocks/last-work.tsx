...
const LastWork = ({ work } : any) => {
	...
	return (
		<article className="fade-in-left-alternate relative isolate flex flex-col justify-end overflow-hidden rounded-3xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
